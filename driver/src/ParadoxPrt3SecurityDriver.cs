...
//   אך *חובה* לאמת את שמות מחלקות הבסיס/המתודות מול גרסת ה-SDK המותקנת אצלך.
//   ההפניות ל-Crestron.RAD.* מגיעות אוטומטית דרך חבילת ה-NuGet
//   Crestron.DeviceDrivers.DevKit (אין צורך ב-HintPath ידני).
//   ראו מדריך הבנייה המלא ב-docs/05-build-crestron-driver.md.
//
//   תיעוד רלוונטי:
